...
bool b_toggleLighting = false;
bool b_birdseyeMode = false;
...
LRESULT CALLBACK WndProc(HWND hWnd, UINT message, WPARAM wParam, LPARAM lParam)
{
	...
	case WM_COMMAND:
		...
		case ID_WIREFRAME_ENABLE:
			b_wireframeMode = true;
			b_toggleLighting = false;
			gGame.b_wireframeMode = b_wireframeMode;
			break;

		case ID_WIREFRAME_DISABLE:
			b_wireframeMode = false;
			b_toggleLighting = false;
			gGame.b_wireframeMode = b_wireframeMode;
			break;

		case ID_LIGHTING_ENABLE:
			b_wireframeMode = false;
			b_toggleLighting = true;
			gGame.b_toggleLighting = b_toggleLighting;
			break;

		case ID_LIGHTING_DISABLE:
			b_wireframeMode = false;
			b_toggleLighting = false;
			gGame.b_toggleLighting = b_toggleLighting;
			break;
	...
	case WM_CREATE:
		...
		CreateTextureWithAlphaFromTGA("assets/Explosion.tga",13);
		...
		CreateTexture("assets/concrete2.bmp", 17);
		...
		CreateTexture("assets/map20.bmp", 21);
		CreateTexture("assets/map16.bmp", 22);
		CreateTexture("assets/map17.bmp", 23);
		CreateTexture("assets/map5.bmp", 24);
		CreateTexture("assets/map19.bmp", 25);
		CreateTexture("assets/map18.bmp", 26);
		CreateTexture("assets/map2.bmp", 27);
		CreateTexture("assets/map7.bmp", 28);
		CreateTexture("assets/map1.bmp", 29);
		CreateTexture("assets/map3.bmp", 30);
		CreateTexture("assets/map4.bmp", 31);
		CreateTexture("assets/map8.bmp", 32);
		CreateTexture("assets/map9a.bmp", 33);
		CreateTexture("assets/map10.bmp", 34);
		CreateTexture("assets/map21.bmp", 35);
		CreateTexture("assets/map12.bmp", 36);
		CreateTexture("assets/map15.bmp", 37);		
		
		CreateTexture("assets/mini.bmp", 38);
		CreateTexture("assets/shotgun.bmp", 39);

		CreateTexture("assets/map12.bmp", 40);	
		CreateTexture("assets/map22.bmp", 41);
		CreateTexture("assets/map14.bmp", 42);
		CreateTexture("assets/map13.bmp", 43);
		CreateTexture("assets/road.bmp", 44);
		
		CreateTextureWithAlphaFromTGA("assets/gun9.tga",45);
		CreateTexture("assets/instructions.bmp",46);
		CreateTexture("assets/openMenu.bmp",47);
		CreateTextureWithAlphaFromTGA("assets/AmmoCrate.tga",48);
		CreateTextureWithAlphaFromTGA("assets/bloodSplatter.tga", 49);
		CreateTextureWithAlphaFromTGA("assets/gun8.tga",50);
		CreateTextureWithAlphaFromTGA("assets/gun7.tga",51);
		CreateTextureWithAlphaFromTGA("assets/gun6.tga",52);
		CreateTextureWithAlphaFromTGA("assets/gun5.tga",53);
		CreateTextureWithAlphaFromTGA("assets/gun4.tga",54);
		CreateTextureWithAlphaFromTGA("assets/gun3.tga",55);
		CreateTextureWithAlphaFromTGA("assets/gun2.tga",56);
		CreateTextureWithAlphaFromTGA("assets/gun1.tga",57);
		CreateTextureWithAlphaFromTGA("assets/gunReload.tga",58);
		CreateTexture("assets/gameOverWin.bmp",59);
		CreateTexture("assets/gameOverLose.bmp",60);
		CreateTexture("assets/amp88.bmp",61);
